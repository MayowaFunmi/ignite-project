            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletAddress = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CryptoCoin = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WalletBallance = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Location = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProfilePicture = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActiveSubscription = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Ratings = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    WithdrawalRequests = table.Column<int>(type: "int", nullable: false),
                    ApprovedRequests = table.Column<int>(type: "int", nullable: false),
                    RejectedRequests = table.Column<int>(type: "int", nullable: false),
                    TotalWithdrawals = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    SignupCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
